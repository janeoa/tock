...
use core::fmt::Write;
use cortexm33::{nvic, CortexM33, CortexMVariant};
use kernel::platform::chip::InterruptService;

pub struct NRF53<'a, I: InterruptService + 'a> {
    mpu: cortexm33::mpu::MPU,
    userspace_kernel_boundary: cortexm33::syscall::SysCall,
    interrupt_service: &'a I,
}

impl<'a, I: InterruptService + 'a> NRF53<'a, I> {
...
/// This struct, when initialized, instantiates all peripheral drivers for the nrf53.
///
...
impl<'a> Nrf53DefaultPeripherals<'a> {
    pub fn new() -> Self {
        Self {
...
impl<'a, I: InterruptService + 'a> kernel::platform::chip::Chip for NRF53<'a, I> {
