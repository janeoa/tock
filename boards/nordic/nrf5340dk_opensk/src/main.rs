//! Tock kernel for the Nordic Semiconductor nRF5340 development kit (DK).
//!
//! It is based on nRF5340 SoC (Cortex M4 core with a BLE transceiver) with
...
// The nRF5340DK LEDs (see back of board)
const LED1_PIN: Pin = Pin::P0_13;
const LED2_PIN: Pin = Pin::P0_14;
const LED3_PIN: Pin = Pin::P0_15;
const LED4_PIN: Pin = Pin::P0_16;

// The nRF5340DK buttons (see back of board)
...
static mut CHIP: Option<&'static nrf5340::chip::NRF52<Nrf5340DefaultPeripherals>> = None;
...
pub struct Platform {
    button: &'static capsules::button::Button<'static, nrf5340::gpio::GPIOPin<'static>>,
    ...
    gpio: &'static capsules::gpio::GPIO<'static, nrf5340::gpio::GPIOPin<'static>>,
    ...
    alarm: &'static capsules::alarm::AlarmDriver<
        'static,
        capsules::virtual_alarm::VirtualMuxAlarm<'static, nrf5340::rtc::Rtc<'static>>,
    >,
...
impl SyscallFilter for Platform {
    fn filter_syscall(
        ...
        match *syscall {
            Syscall::Command {
                driver_number: nrf5340::nvmc::DRIVER_NUM,
...
#[inline(never)]
unsafe fn get_peripherals() -> &'static mut Nrf5340DefaultPeripherals<'static> {
...
impl KernelResources<nrf5340::chip::NRF52<'static, Nrf5340DefaultPeripherals<'static>>>
    for Platform
{
...
pub unsafe fn main() {
    ...
    nrf5340::init();
    // Initialize chip peripheral drivers
    let nrf5340_peripherals = get_peripherals();
    ...
    let gpio = components::gpio::GpioComponent::new(
        ...
        components::gpio_component_helper!(
            ...
            14 => &nrf5340_peripherals.gpio_port[Pin::P0_26],
            15 => &nrf5340_peripherals.gpio_port[Pin::P0_27]
        ),
    )
    .finalize(components::gpio_component_buf!(nrf5340::gpio::GPIOPin));
    ...
    .finalize(components::button_component_buf!(nrf5340::gpio::GPIOPin));
    ...
    let chip = static_init!(
        nrf5340::chip::NRF52<Nrf5340DefaultPeripherals>,
        nrf5340::chip::NRF52::new(nrf5340_peripherals)
    );
    CHIP = Some(chip);
    ...
    let mux_alarm = components::alarm::AlarmMuxComponent::new(rtc)
        .finalize(components::alarm_mux_component_helper!(nrf5340::rtc::Rtc));
    let alarm = components::alarm::AlarmDriverComponent::new(
        board_kernel,
        capsules::alarm::DRIVER_NUM,
        mux_alarm,
    )
    .finalize(components::alarm_component_helper!(nrf5340::rtc::Rtc));
    ...
    let nvmc = static_init!(
        ...
        nrf5340::nvmc::SyscallDriver::new(
            &base_peripherals.nvmc,
            board_kernel.create_grant(nrf5340::nvmc::DRIVER_NUM, &memory_allocation_capability),
    ...
    let usb = components::usb_ctap::UsbCtapComponent::new(
        ...
        capsules::usb::usbc_client::MAX_CTRL_PACKET_SIZE_NRF5340,
        VENDOR_ID,
        PRODUCT_ID,
        STRINGS,
    )
    ...
    debug!("{}", &nrf5340::ficr::FICR_INSTANCE);
