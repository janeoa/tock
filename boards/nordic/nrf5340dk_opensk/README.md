Platform-Specific Instructions: nRF5340-DK
===================================

This is an adapted nrf5340dk made to work with OpenSK.

The [nRF5340 Development
Kit](https://www.nordicsemi.com/Software-and-Tools/Development-Kits/nRF5340-DK) is a platform
based around the nRF5340, an SoC with an ARM Cortex-M4 and a BLE
...
Viewing console output on the nrf5340dk is slightly different from other boards. You must use
```bash
$ tockloader listen
```
